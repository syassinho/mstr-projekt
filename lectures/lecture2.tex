...
\mode<presentation>{
   ...
   \title{Lecture 2}
   \TitleTextBox[Ziel:]{Verständnis Lecture 2}
...
\subsection[Subsection 1]{Subsection 1 of Section 1}
\label{ssec:sec2a}
...
\frametitle{Frame 1 of Subsection 1 of Section 2}
...
\subsection[Übungen]{Übungen \scriptonly{zu Abschnitt \ref{sec:sec2}}}
\label{ssec:exercisesec2}
